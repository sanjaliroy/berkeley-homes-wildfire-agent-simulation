...
def judge_intervention(
    ...
    system = (
        ...
        "A non-compliant response, an ironic deflection, or an ecological reframing can "
        "all be highly plausible if they match the agent's established worldview.\n\n"
    ...
    user = (
        ...
        "to this agent's circumstances (e.g. a renter's limited agency, a skeptic's "
        "ironic acceptance, an activist's reframing)\n\n"
        "2. PERSONA CONSISTENCY — Ask yourself: would this response be meaningfully "
        "different if the agent had a different seed narrative? If not, score 3 or below. "
        "Note: distinctive communication style, tone, and framing count as persona "
        ...
        "specific history, named experiences, dollar amounts, or distinctive voice "
        "do not surface | "
        "5=Clearly reflects details unique to this agent — specific costs, named people "
...
def judge_full_simulation(
    ...
    system = (
        ...
        "for a generic cooperative homeowner. A consistent pattern of non-compliance, "
        "ironic skepticism, or ecological reframing is highly plausible if it matches "
        "the agent's established worldview.\n\n"
    ...
    user = (
        ...
        "situational nuance unique to this agent (e.g. a renter's limited agency, "
        "a skeptic's ironic acceptance, an activist's persistent reframing)\n\n"
