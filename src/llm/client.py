...
def judge_intervention(
    ...
    system = (
        ...
        "Be critical and discriminating. Every point on each scale is defined below; "
        "use the definitions rather than an overall impression, and use the full range "
        "where the response warrants it."
    )
    user = (
        ...
        "1. BEHAVIORAL PLAUSIBILITY — How plausible, if at all, is this reasoning for "
        "someone in this resident's circumstances?\n"
        "   1=Not plausible. Incoherent, contradicts basic facts of the situation, or "
        "no resident would reason this way.\n"
        "   2=Barely plausible. Followable, but rests on a clear misunderstanding of the "
        "situation or makes a leap no resident would make.\n"
        "   3=Reasonable but generic. Sensible, but the reasoning could apply to almost "
        "anyone facing this situation.\n"
        "   4=Reasonable and situationally specific. Engages concrete features of this "
        "situation such as costs, timing, or constraints.\n"
        "   5=Nuanced situational understanding. Weighs competing pressures or tradeoffs "
        "specific to this situation in a way that shows a meaningful grasp of what is at "
        "stake.\n\n"
        "2. PERSONA CONSISTENCY — How different, if at all, would this response be if the "
        "resident had a different seed narrative? Note: distinctive communication style, "
        "tone, and framing count as persona signals.\n"
        "   1=Contradicts the seed personality or key memory seeds.\n"
        "   2=No contradiction, but off. Nothing conflicts outright, but tone, priorities "
        "or framing do not fit this resident.\n"
        "   3=Consistent with a generic version of this persona type but lacking nuance: "
        "the resident's specific history, experiences or distinctive voice do not surface.\n"
        "   4=Reflects at least one detail unique to this resident, such as a specific "
        "cost, person, place, opinion, characteristic tone, or prior experience from the "
        "seed narrative or memory seeds.\n"
        "   5=Clearly reflects details unique to this resident: specific costs, people or "
        "places, distinctive opinions, characteristic tone, or prior experiences from the "
        "seed narrative or memory seeds.\n\n"
        "3. INTERVENTION RESPONSIVENESS — How specifically, if at all, did the resident "
        "engage with the content of this intervention?\n"
        "   1=Ignored the intervention or gave a fully generic response.\n"
        "   2=Acknowledged that the intervention happened, but the response could apply "
        "to several different interventions.\n"
        "   3=Acknowledged the event and responded appropriately but did not engage with "
        "its specific details.\n"
        "   4=Engaged with specifics. Referenced concrete details from this intervention.\n"
...
def judge_full_simulation(
    ...
    system = (
        ...
        "Be critical and discriminating. Every point on each scale is defined below; "
        "use the definitions rather than an overall impression, and use the full range "
        "where the trajectory warrants it."
    )
    user = (
        f"RESIDENT SEED NARRATIVE:\n{seed_narrative}\n\n"
        f"RESIDENT MEMORY SEEDS (background experiences):\n{seeds_text}\n\n"
        ...
        "   1=Not plausible. Incoherent across events, contradicts basic facts of the "
        "situation, or no resident would behave this way.\n"
        "   2=Barely plausible. Followable, but rests on a clear misunderstanding of the "
        "situation or makes leaps no resident would make.\n"
        ...
        "   4=Reasonable and situationally specific. Engages concrete features of the "
        "events, such as costs, timing, or constraints, across the trajectory.\n"
        "   5=Consistently reflects the specific competing pressures, constraints, and "
        "situational nuance unique to this resident.\n\n"
        "2. PERSONA CONSISTENCY — Would this trajectory look meaningfully different if the "
        "resident had a different seed narrative? Note: distinctive communication style, "
        "characteristic tone, and recurring framings count as persona signals — not just "
        "factual content.\n"
        "   1=Contradicts the seed personality or key memory seeds across multiple events.\n"
        "   2=No contradiction, but off. Nothing conflicts outright, but tone, priorities "
        "or framing do not fit this resident.\n"
        "   3=Broadly consistent with this persona type, but the resident's specific "
        "history, named experiences, dollar amounts, or distinctive voice rarely surface.\n"
        "   4=Reflects details unique to this resident at several points in the trajectory, "
        "such as specific costs, people, places, or prior experiences.\n"
        "   5=The resident's unique history and specific traits are clearly present "
        "throughout — responses reference named people, places, costs, or opinions that "
        "could only come from this seed, and their characteristic voice is recognisable.\n\n"
        ...
        "   2=Acknowledged that interventions happened, but responses could apply to "
        ...
        "   4=Engaged with specifics. Referenced concrete details from individual "
        "interventions across the trajectory.\n"
