...
def judge_intervention(
    ...
    system = (
        ...
        "from this particular agent — not any reasonable homeowner. "
    ...
    user = (
        ...
        "1. BEHAVIORAL PLAUSIBILITY — How plausible is this reasoning for a real homeowner "
        "in this specific situation?\n"
        "   1=Not at all plausible | "
        "3=Reasonable but generic — could apply to any cautious/reluctant homeowner | "
        "5=Reflects competing pressures and trade-offs specific to this agent's circumstances\n\n"
        "2. PERSONA CONSISTENCY — Ask yourself: would this response be meaningfully different "
        "if the agent had a different seed narrative? If not, score 3 or below.\n"
        "   1=Contradicts the seed personality or key memory seeds | "
        "3=Consistent with a generic version of this persona type but ignores specific "
        "details, history, or named experiences from the seed | "
        "5=Clearly reflects details unique to this agent — specific values, dollar amounts, "
        "named fears, or prior experiences from the seed narrative or memory seeds\n\n"
        "3. INTERVENTION RESPONSIVENESS — How specifically did the agent engage with this "
        "intervention's content?\n"
        "   1=Ignored the intervention or gave a generic response | "
        "3=Acknowledged the event and responded appropriately but did not engage with its "
        "specific details | "
        "5=Integrated specific details from this intervention with prior context in a way "
        "that shows genuine processing\n\n"
...
def judge_full_simulation(
    ...
    user = (
        ...
        "   1=Not at all plausible | "
        "3=Reasonable across events but generic — behaviour reflects common homeowner "
        "patterns rather than this agent's specific circumstances | "
        "5=Consistently reflects competing pressures, trade-offs, and situational nuance "
        ...
        "3=Broadly consistent with this persona type but specific details, named experiences, "
        "or values from the seed rarely surface in decisions or reasoning | "
        "5=The agent's unique history and specific traits are clearly present throughout — "
        "responses reference or reflect named experiences, specific values, or details that "
        "could only come from this seed\n\n"
        ...
        "3=Acknowledged events and responded appropriately but typically at a generic level "
        "without integrating specific intervention details | "
